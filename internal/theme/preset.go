...
var presetDefinitions = map[string]presetDefinition{
	...
	"grey": {
		Preset: Preset{Name: "grey", Label: "Grey"},
		base:   presetBaseLight,
		overrides: Palette{
			ActiveBorderHex:                      "#000000",
			InactiveBorderHex:                    "#CCCCCC",
			InactiveTitleHex:                     "#5E5E5E",
			SuccessHex:                           "#1C5708",
			SuccessBackgroundHex:                 "#DFEACC",
			FailureHex:                           "#C4331D",
			FailureBackgroundHex:                 "#F5DEE0",
			PendingHex:                           "#5E5E5E",
			PendingBackgroundHex:                 "#ECECEC",
			MutedHex:                             "#5E5E5E",
			WarningHex:                           "#B37F02",
			PullRequestReferenceHex:              "#5E5E5E",
			...
			MarkdownLinkHex:                      "#1561B8",
			MarkdownCodeHex:                      "#A55000",
			SyntaxKeywordHex:                     "#000000",
			SyntaxKeywordStyle:                   []string{TextStyleBold},
			SyntaxFunctionHex:                    "#000000",
			SyntaxTypeHex:                        "#000000",
			SyntaxPropertyHex:                    "#000000",
			SyntaxStringHex:                      "#1C5708",
			SyntaxNumberHex:                      "#1561B8",
			SyntaxCommentHex:                     "#5E5E5E",
			CommentAuthorBadgeHex:                "#1561B8",
			CommentAuthorBadgeBackgroundHex:      "#E6E6E6",
			PullRequestStatusMergedHex:           "#5C21A5",
			PullRequestStatusMergedBackgroundHex: "#E6E6E6",
			DiffAdditionHighlightBackgroundHex:   "#CADDD2",
			DiffDeletionHighlightBackgroundHex:   "#EFCED1",
			DiffLineNumberHex:                    "#5E5E5E",
			TeamOwnershipHex:                     "#5E5E5E",
			DiffHunkHeaderHex:                    "#1561B8",
		},
	},
	"catppuccin-latte": {
