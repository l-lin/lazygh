...
var presetDefinitions = map[string]presetDefinition{
	...
	"catppuccin-frappe": {
		...
		overrides: Palette{
			...
			PullRequestStatusOpenHex:             "#303446",
			PullRequestStatusClosedHex:           "#303446",
			PullRequestStatusMergedHex:           "#303446",
			PullRequestStatusMergedBackgroundHex: "#CA9EE6",
	...
	"catppuccin-macchiato": {
		...
		overrides: Palette{
			...
			PullRequestStatusOpenHex:             "#24273A",
			PullRequestStatusClosedHex:           "#24273A",
			PullRequestStatusMergedHex:           "#24273A",
			PullRequestStatusMergedBackgroundHex: "#C6A0F6",
	...
	"catppuccin-mocha": {
		...
		overrides: Palette{
			...
			PullRequestStatusOpenHex:             "#1E1E2E",
			PullRequestStatusClosedHex:           "#1E1E2E",
			PullRequestStatusMergedHex:           "#1E1E2E",
			PullRequestStatusMergedBackgroundHex: "#CBA6F7",
