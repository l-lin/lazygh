...
func newDefaultLightPalette() Palette {
	...
	successHex := "#1A7F37"
	successBackgroundHex := "#DBEAE1"
	failureHex := "#CF222E"
	failureBackgroundHex := "#F5DEE0"
	warningHex := "#9A6700"
	...
	return Palette{
		...
		ActionsPopupGroupBackgroundHex:       searchHighlightHex,
		...
		DiffAdditionHighlightBackgroundHex:   "#CADDD2",
		DiffDeletionHex:                      failureHex,
		DiffDeletionBackgroundHex:            failureBackgroundHex,
		DiffDeletionHighlightBackgroundHex:   "#EFCED1",
...
func newDefaultDarkPalette() Palette {
	...
	return Palette{
		...
		ActionsPopupGroupForegroundHex:       activeTextHex,
		ActionsPopupGroupBackgroundHex:       "#58A6FF",
