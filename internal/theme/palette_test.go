...
const (
	...
	lightDefaultSuccessBackgroundHex               = "#DBEAE1"
	lightDefaultFailureHex                         = "#CF222E"
	lightDefaultFailureBackgroundHex               = "#F5DEE0"
	lightDefaultDiffAdditionBackgroundHex          = "#DBEAE1"
	lightDefaultDiffAdditionHighlightBackgroundHex = "#CADDD2"
	lightDefaultDiffDeletionBackgroundHex          = "#F5DEE0"
	lightDefaultDiffDeletionHighlightBackgroundHex = "#EFCED1"
