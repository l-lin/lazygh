...
type pullRequestMergeWhenReadyState int

const (
	pullRequestMergeWhenReadyStateQueue pullRequestMergeWhenReadyState = iota
	pullRequestMergeWhenReadyStateAutoMerge
)
...
func (MsgPullRequestMergeWhenReadyRequested) isMsg()      {}
