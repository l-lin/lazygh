...
func TestStatusLineKeyHints_GivenPullRequestCustomSearchEditor_WhenRendering_ThenItShowsEnterSubmitAndNoModalFooter(t *testing.T) {
	...
	then_statusLineKeyHintsAre(t, gui, "Enter: submit, Ctrl+G: editor, Escape: cancel")
	then_statusLineKeyHintsAreRightAligned(t, gui, "Enter: submit, Ctrl+G: editor, Escape: cancel")
	then_viewLineSegmentHasForegroundColor(t, gui, viewStatusLineKeyHintsName, 0, "Enter: submit, Ctrl+G: editor, Escape: cancel", given_themeColorHex(t, theme.InactiveTitleHex), "custom search key hints")
}
