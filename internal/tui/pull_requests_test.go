...
func TestPullRequestRow_GivenPullRequestStatuses_WhenBuildingTheListRow_ThenItPrependsAStateColoredIcon(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			expectedIconPrefix:      foregroundColorEscape(theme.PullRequestStatusOpenForegroundHex),
		...
		},
		{
			...
			expectedIconPrefix:      foregroundColorEscape(theme.PullRequestStatusDraftForegroundHex),
		...
		},
		{
			...
			expectedIconPrefix:      foregroundColorEscape(theme.PullRequestStatusClosedForegroundHex),
		...
		},
		{
			...
			expectedIconPrefix:      foregroundColorEscape(theme.PullRequestStatusMergedForegroundHex),
