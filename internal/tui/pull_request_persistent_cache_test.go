...
func TestLayout_GivenCachedPullRequestsAndLiveResults_WhenRendering_ThenItSortsRowsByUpdatedAt(t *testing.T) {
	...
	if newerIndex > olderIndex {
		t.Fatalf("expected the newer live row to appear first, actual %q", actualBuffer)
	}
}
