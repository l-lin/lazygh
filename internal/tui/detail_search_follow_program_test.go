...
func TestKeybindingSpecs_GivenProgram_WhenListingDetailSearchFollowBindings_ThenTheyExistOnlyOnTheDetailView(t *testing.T) {
	...
	for _, viewName := range []string{viewUserName, viewPullRequestsName, viewSearchName} {
