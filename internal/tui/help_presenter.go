	...
	if actionContext.IsReviewContext() {
		...
		case FocusDetailView:
			entries := []helpEntry{
				...
				{Key: presenter.helpKeysOrFallback("o", keybindingActionID{scope: keymapScopeCursor, action: "move_cursor_to_other_end"}), Description: "Move cursor to other end of selection"},
