...
func (program *Program) keybindingActions() []keybindingAction {
	return []keybindingAction{
		...
		configuredKeybindingActionFor(keymapScopePullRequests, "open_pull_request_by_url", []string{viewPullRequestsName}, program.openPullRequestByURLShortcut),
		...
		configuredKeybindingActionFor(keymapScopePullRequests, "open_pull_request_by_url", []string{viewDetailName}, program.openPullRequestByURLShortcut),
