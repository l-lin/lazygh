...
var sharedKeybindingDefinitions = map[string]sharedKeybindingDefinition{
	...
	"refresh":                            sharedKeybindingDefinitionWithDefaultBindings(keymapScopeGlobal, "refresh"),
	...
	"start_yank":                         sharedKeybindingDefinitionWithDefaultBindings(keymapScopeCursor, "start_yank"),
	"move_cursor_to_other_end":           sharedKeybindingDefinitionWithDefaultBindingsAndSequencePolicy(keymapScopeCursor, "move_cursor_to_other_end", false),
	...
	"open_pull_request_in_browser":       sharedKeybindingDefinitionWithDefaultBindings(keymapScopePullRequests, "open_pull_request_in_browser"),
...
func (program *Program) keybindingActions() []keybindingAction {
	actions := []keybindingAction{
		...
		sharedKeybindingActionFor(keymapScopeUser, "open_pull_request_in_browser", []string{viewUserName}, program.openPullRequestInBrowserShortcut),
		...
		configuredKeybindingActionFor(keymapScopeCursor, "display_commit_changes", []string{viewDetailName}, program.displayCommitChangesShortcut),
		configuredKeybindingActionFor(keymapScopeCursor, "toggle_word_wrap", []string{viewDetailName}, program.toggleDetailWordWrap),
		configuredKeybindingActionFor(keymapScopeCursor, "search_word_under_cursor_forward", []string{viewDetailName}, program.searchWordUnderCursorForward),
		configuredKeybindingActionFor(keymapScopeCursor, "search_word_under_cursor_backward", []string{viewDetailName}, program.searchWordUnderCursorBackward),
		...
		sharedKeybindingActionFor(keymapScopeCursor, "start_yank", []string{viewDetailName}, program.startDetailYank),
		keybindingActionWithoutSetup(sharedKeybindingActionFor(keymapScopeCursor, "move_cursor_to_other_end", []string{viewDetailName}, program.moveDetailCursorToOtherEnd)),
		...
		sharedKeybindingActionFor(keymapScopePullRequests, "open_pull_request_in_browser", []string{viewDetailName}, program.openPullRequestInBrowserShortcut),
		...
		configuredKeybindingActionFor(keymapScopePullRequests, "open_pull_request_by_url", []string{viewDetailName}, program.openPullRequestByClipboardShortcut),
		...
		sharedKeybindingActionFor(keymapScopePullRequestBuildInfo, "start_yank", []string{viewPullRequestBuildInfoName}, program.startPullRequestBuildRunPopupYank),
		sharedKeybindingActionFor(keymapScopePullRequestBuildInfo, "open_pull_request_in_browser", []string{viewPullRequestBuildInfoName}, program.openPullRequestInBrowserShortcut),
		keybindingActionWithoutSetup(sharedKeybindingActionFor(keymapScopePullRequestBuildInfo, "move_cursor_to_other_end", []string{viewPullRequestBuildInfoName}, program.movePullRequestBuildRunPopupCursorToOtherEnd)),
