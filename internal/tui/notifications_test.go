...
func TestNotificationRow_GivenPullRequestNotification_WhenBuilding_ThenItUsesAShortReferenceAndGreyReferenceSegment(t *testing.T) {
...
func TestNotificationListReference_GivenNotificationKinds_WhenBuilding_ThenItUsesShortRepositoryLabels(t *testing.T) {
	testCases := []struct {
		name         string
		notification githubdomain.Notification
		expected     string
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			actual := notificationListReference(testCase.notification)
