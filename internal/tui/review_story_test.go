...
func TestReviewStoryMode_GivenTheAgentIsStillRunning_WhenStartingStoryReview_ThenTheStatusLineShowsTheResolvedAgentCommand(t *testing.T) {
	...
	then_statusLineContains(t, gui, "Running `pi --models anthropic/claude-sonnet-4-6 --no-session -p @<prompt_file>`.")
	if subject.navigationState.reviewSession.active {
