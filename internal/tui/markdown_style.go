...
func applyMarkdownCodeBlockTheme(style *glamouransi.StyleConfig) {
	...
	applyTextStyles(&style.CodeBlock.Chroma.Comment, theme.SyntaxCommentStyle)
	style.CodeBlock.Chroma.CommentPreproc.Color = stringPtr(theme.SyntaxKeywordHex)
	applyTextStyles(&style.CodeBlock.Chroma.CommentPreproc, theme.SyntaxKeywordStyle)
	style.CodeBlock.Chroma.Keyword.Color = stringPtr(theme.SyntaxKeywordHex)
	applyTextStyles(&style.CodeBlock.Chroma.Keyword, theme.SyntaxKeywordStyle)
	style.CodeBlock.Chroma.KeywordReserved.Color = stringPtr(theme.SyntaxKeywordHex)
	applyTextStyles(&style.CodeBlock.Chroma.KeywordReserved, theme.SyntaxKeywordStyle)
	style.CodeBlock.Chroma.KeywordNamespace.Color = stringPtr(theme.SyntaxKeywordHex)
	applyTextStyles(&style.CodeBlock.Chroma.KeywordNamespace, theme.SyntaxKeywordStyle)
	style.CodeBlock.Chroma.KeywordType.Color = stringPtr(theme.SyntaxTypeHex)
	applyTextStyles(&style.CodeBlock.Chroma.KeywordType, theme.SyntaxTypeStyle)
	style.CodeBlock.Chroma.Operator.Color = stringPtr(theme.SyntaxKeywordHex)
	applyTextStyles(&style.CodeBlock.Chroma.Operator, theme.SyntaxKeywordStyle)
	...
	applyTextStyles(&style.CodeBlock.Chroma.NameBuiltin, theme.SyntaxFunctionStyle)
	style.CodeBlock.Chroma.NameTag.Color = stringPtr(theme.SyntaxTypeHex)
	applyTextStyles(&style.CodeBlock.Chroma.NameTag, theme.SyntaxTypeStyle)
	style.CodeBlock.Chroma.NameAttribute.Color = stringPtr(theme.SyntaxPropertyHex)
	applyTextStyles(&style.CodeBlock.Chroma.NameAttribute, theme.SyntaxPropertyStyle)
	style.CodeBlock.Chroma.NameClass.Color = stringPtr(theme.SyntaxTypeHex)
	applyTextStyles(&style.CodeBlock.Chroma.NameClass, theme.SyntaxTypeStyle)
	style.CodeBlock.Chroma.NameConstant.Color = stringPtr(theme.SyntaxPropertyHex)
	applyTextStyles(&style.CodeBlock.Chroma.NameConstant, theme.SyntaxPropertyStyle)
	style.CodeBlock.Chroma.NameDecorator.Color = stringPtr(theme.SyntaxKeywordHex)
	applyTextStyles(&style.CodeBlock.Chroma.NameDecorator, theme.SyntaxKeywordStyle)
	style.CodeBlock.Chroma.NameException.Color = stringPtr(theme.SyntaxTypeHex)
	applyTextStyles(&style.CodeBlock.Chroma.NameException, theme.SyntaxTypeStyle)
	style.CodeBlock.Chroma.NameFunction.Color = stringPtr(theme.SyntaxFunctionHex)
	applyTextStyles(&style.CodeBlock.Chroma.NameFunction, theme.SyntaxFunctionStyle)
	style.CodeBlock.Chroma.NameOther.Color = stringPtr(theme.SyntaxPropertyHex)
	applyTextStyles(&style.CodeBlock.Chroma.NameOther, theme.SyntaxPropertyStyle)
	style.CodeBlock.Chroma.Literal.Color = stringPtr(theme.SyntaxStringHex)
	applyTextStyles(&style.CodeBlock.Chroma.Literal, theme.SyntaxStringStyle)
	style.CodeBlock.Chroma.LiteralNumber.Color = stringPtr(theme.SyntaxNumberHex)
	applyTextStyles(&style.CodeBlock.Chroma.LiteralNumber, theme.SyntaxNumberStyle)
	style.CodeBlock.Chroma.LiteralDate.Color = stringPtr(theme.SyntaxNumberHex)
	applyTextStyles(&style.CodeBlock.Chroma.LiteralDate, theme.SyntaxNumberStyle)
	style.CodeBlock.Chroma.LiteralString.Color = stringPtr(theme.SyntaxStringHex)
	applyTextStyles(&style.CodeBlock.Chroma.LiteralString, theme.SyntaxStringStyle)
	style.CodeBlock.Chroma.LiteralStringEscape.Color = stringPtr(theme.SyntaxStringHex)
	applyTextStyles(&style.CodeBlock.Chroma.LiteralStringEscape, theme.SyntaxStringStyle)
	style.CodeBlock.Chroma.GenericDeleted.Color = stringPtr(theme.DiffDeletionHex)
	style.CodeBlock.Chroma.GenericEmph.Italic = boolPtr(true)
	style.CodeBlock.Chroma.GenericInserted.Color = stringPtr(theme.DiffAdditionHex)
